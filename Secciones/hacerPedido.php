                            ...
                            <div class="popup-contentPagar">
                                ...
                                <div class="datosTarjeta">
                                    <div class="tarjetaIzquierda">
                                        ...
                                        <i><input type="text" style="width: 100%;" placeholder="Como aparece en la tarjeta"></i>
                                        <h5>Fecha De Expiración</h5>
                                        <div>
                                            <input type="number" style="margin-right: 19%" min="01" step="1" max="12" placeholder="Mes">
                                            <input type="number" style="margin-left: 19%" min="2021" step="1" max="2030" placeholder="Año">
                                        </div>
                                    </div>

                                    <div class="tarjetaIzquierda">
                                        <h5>Número De Tarjeta</h5>
                                        <i><input type="password" style="width: 100%;" placeholder="XXXX-XXXX-XXXX-XXXX"></i>
                                        <h5>Código De Seguridad</h5>
                                        <div style="display: flex; align-items: center;">
                                            <input type="password" placeholder="3 dígitos" maxlength="3">
