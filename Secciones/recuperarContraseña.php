                ...
                <div class="card"><br>
                    ...
                    <div class="ComidasMenu">
                        ...
                        <div class="item">
                            ...
                            <input type="email" id="correo" name="correo" placeholder="Ej: usuario@ejemplo.com" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" maxlength="200" required checked>
                        ...
                        <h2>El proceso de recuperación de contraseñas puede tardar unos minutos...</h2>
                        <div class="item">
                            <input type="reset" class="botones" value="Vaciar">
                            <input type="submit" class="botones" value="Ingresar" onclick="window.location.href='../index.html'">
                        </div>
                    </div>
                </div>
            </form>
